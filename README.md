...
Migration `007_stock_and_quantity_pricing.sql` includes the stock upgrade and updates pricing to multiply the per-print weight by quantity. Run it after migration 005; migration 006 is not needed if you use 007.

The latest upgrade is `008_inventory_quantity_and_print_time.sql`. Run it after migration 005 instead of migrations 006 and 007. It adds stock controls, quantity-aware pricing, and a configurable machine-time rate (10 kr/hour by default).
